...
PySequenceMethods pyfvde_logical_volumes_sequence_methods = {
	/* sq_length */
	(lenfunc) pyfvde_logical_volumes_len,
	/* sq_concat */
	0,
	/* sq_repeat */
	0,
	/* sq_item */
	(ssizeargfunc) pyfvde_logical_volumes_getitem,
	/* sq_slice */
	0,
	/* sq_ass_item */
	0,
...
PyTypeObject pyfvde_logical_volumes_type_object = {
	PyVarObject_HEAD_INIT( NULL, 0 )

	/* tp_name */
	"pyfvde.logical_volumes",
	/* tp_basicsize */
	sizeof( pyfvde_logical_volumes_t ),
	/* tp_itemsize */
	0,
	/* tp_dealloc */
	(destructor) pyfvde_logical_volumes_free,
	/* tp_print */
	0,
	/* tp_getattr */
	0,
	...
	0,
	/* tp_as_sequence */
	&pyfvde_logical_volumes_sequence_methods,
	/* tp_as_mapping */
	0,
	/* tp_hash */
	0,
	...
	/* tp_doc */
	"pyfvde sequence and iterator object of logical volumes",
	/* tp_traverse */
	0,
	/* tp_clear */
	0,
	...
	0,
	/* tp_iter */
	(getiterfunc) pyfvde_logical_volumes_iter,
	/* tp_iternext */
	(iternextfunc) pyfvde_logical_volumes_iternext,
	/* tp_methods */
	0,
	/* tp_members */
	0,
	...
	0,
	/* tp_init */
	(initproc) pyfvde_logical_volumes_init,
	/* tp_alloc */
	0,
	/* tp_new */
	0,
 ...
 */
PyObject *pyfvde_logical_volumes_new(
           ...
           int number_of_items )
{
	pyfvde_logical_volumes_t *sequence_object = NULL;
	static char *function                     = "pyfvde_logical_volumes_new";
	...
	sequence_object = PyObject_New(
	                   struct pyfvde_logical_volumes,
	                   &pyfvde_logical_volumes_type_object );
 ...
 */
int pyfvde_logical_volumes_init(
     pyfvde_logical_volumes_t *sequence_object )
{
	static char *function = "pyfvde_logical_volumes_init";
 ...
 */
void pyfvde_logical_volumes_free(
      pyfvde_logical_volumes_t *sequence_object )
{
	struct _typeobject *ob_type = NULL;
	static char *function       = "pyfvde_logical_volumes_free";
 ...
 */
Py_ssize_t pyfvde_logical_volumes_len(
            pyfvde_logical_volumes_t *sequence_object )
{
	static char *function = "pyfvde_logical_volumes_len";
 ...
 */
PyObject *pyfvde_logical_volumes_getitem(
           pyfvde_logical_volumes_t *sequence_object,
           Py_ssize_t item_index )
{
	PyObject *logical_volume_object = NULL;
	static char *function           = "pyfvde_logical_volumes_getitem";
 ...
 */
PyObject *pyfvde_logical_volumes_iter(
           pyfvde_logical_volumes_t *sequence_object )
{
	static char *function = "pyfvde_logical_volumes_iter";
 ...
 */
PyObject *pyfvde_logical_volumes_iternext(
           pyfvde_logical_volumes_t *sequence_object )
{
	PyObject *logical_volume_object = NULL;
	static char *function           = "pyfvde_logical_volumes_iternext";
