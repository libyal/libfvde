...
const char *libfvde_get_version(
             void )
{
	return( (const char *) LIBFVDE_VERSION_STRING );
}
...
int libfvde_get_access_flags_read(
     void )
{
	return( (int) LIBFVDE_ACCESS_FLAG_READ );
}
...
{
	static char *function = "libfvde_get_codepage";
...
int libfvde_set_codepage(
     ...
     libcerror_error_t **error )
{
	static char *function = "libfvde_set_codepage";
     ...
     libcerror_error_t **error )
{
	...
	static char *function            = "libfvde_check_volume_signature";
...
{
	libbfio_handle_t *file_io_handle = NULL;
	static char *function            = "libfvde_check_volume_signature_wide";
	size_t filename_length           = 0;
	int result                       = 0;
     ...
     libcerror_error_t **error )
{
	...
	if( read_count != 2 )
	{
		libcerror_error_set(
		 ...
		 "%s: unable to read signature at offset: 88 (0x00000058).",
		 function );
