...
$Filename = "${pwd}\win_flex_bison-2.5.11.zip"
$Url = "http://downloads.sourceforge.net/project/winflexbison/win_flex_bison-2.5.11.zip"
$ExtractedPath = "win_flex_bison-2.5.11"
